...
//practice1();
	...
	public static void testcase () {
        ...
        driver.findElement(By.xpath("//*[@id=\"HTML6\"]/h2")).click();
        // Step 3: Switch to the iFrame by ID
        driver.switchTo().frame("frame-one796456169");
        // Step 4: Fill in the information
        driver.findElement(By.xpath("//input[@name='RESULT_TextField-0']")).sendKeys("hamzah");
        WebElement genderMale = driver.findElement(By.xpath("//*[@id=\"q2\"]/table/tbody/tr[1]/td/label"));
        genderMale.click();
        WebElement dob = driver.findElement(By.xpath("//*[@id=\"RESULT_TextField-2\"]"));
        dob.click();
        dob.sendKeys("01/01/1990");
        // Step 6: Select a value from the dropdown
        driver.findElement(By.xpath("//*[@id=\"RESULT_RadioButton-3\"]")).click();
        // Step 7: Click on the "Submit" button
        driver.findElement(By.id("FSsubmit")).click();
        // Step 8: Switch back to the main frame
        driver.switchTo().defaultContent();
        // Step 9: Get and verify the text
        String verificationText = driver.getTitle();
        if (verificationText.equals("Automation Testing Practice")) {
